...
class VentanaPrincipal(QMainWindow):
    ...
    # Cargar GIF en el QLabel de la página page_dos
        gif_path = "C:/Users/ORG LESBOS/PycharmProjects/CnC/interfaz/imagenes/Pan.gif"  # Reemplaza con la ruta correcta de tu archivo GIF
        movie = QMovie(gif_path)
        label = self.page_dos.findChild(QtWidgets.QLabel, "label_uno")  # Reemplaza "label_animacion" con el nombre real de tu QLabel
    ...
    def Cancelando(self):
        ...
        movie = QMovie(gif_path)
        label = self.page_tres.findChild(QtWidgets.QLabel, "label_dos")  # Reemplaza "label_animacion" con el nombre real de tu QLabel
        label.setMovie(movie)
        # Ajustar el tamaño máximo del QLabel
        label.setMaximumSize(431, 331)  # Ajusta según tus necesidades
        # Ajustar la escala del GIF para que se ajuste al tamaño máximo
