...
#TITULO INICIAL
        ...
        self.titulo.text = "MAQUINA FRESADORA CNC"
        self.titulo.geometry = QRect(0, 0, 480, 60)
        ...
        self.fr_inputs.geometry = QRect(10, 120, 480, 170)
        self.fr_inputs.style_sheet = "background: #fc79f2;"


#BOTON
        self.boton = QPushButton(self.fr_inputs)
        self.boton.text = "Comenzar!"

        self.boton.geometry = QRect(10, 55, 460, 70)
